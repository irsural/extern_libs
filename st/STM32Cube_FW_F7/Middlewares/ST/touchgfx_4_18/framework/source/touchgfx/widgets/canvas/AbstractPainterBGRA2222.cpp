        ...
        do
        {
            ...
            if (renderNext(red, green, blue, alpha))
            {
                ...
                else
                {
                    ...
                    const uint8_t p_red = LCD8bpp_BGRA2222::getRedFromNativeColor(*p);
                    const uint8_t p_green = LCD8bpp_BGRA2222::getGreenFromNativeColor(*p);
                    const uint8_t p_blue = LCD8bpp_BGRA2222::getBlueFromNativeColor(*p);
                    renderPixel(p,
...
{
    *p = LCD8bpp_BGRA2222::getNativeColorFromRGB(red, green, blue);
}
} // namespace touchgfx
