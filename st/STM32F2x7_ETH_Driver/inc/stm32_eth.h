...
/** 
  * @brief  For KS8721bl  
  */ 
#define PHY_Speed_Status            ((uint16_t)(1 << 2))    /*!< Configured information of Speed: 10Mbps */
#define PHY_Duplex_Status           ((uint16_t)(1 << 4))    /*!< Configured information of Duplex: Full-duplex */
