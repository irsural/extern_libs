...
#define EXTRA_TX_FID_BIT0               (1 << 11)
#define EXTRA_TX_FID_BIT1               (1 << 12)
...
typedef struct
{
  ...
  uint8_t video_control_altinterface;
...
#define VIDEO_MAX_VIDEO_STD_INTERFACE      0x06
...
#define VIDEO_MAX_MJPEG_FRAME_D            40

#define VIDEO_MAX_UNCOMP_FORMAT            3
#define VIDEO_MAX_UNCOMP_FRAME_D           40
